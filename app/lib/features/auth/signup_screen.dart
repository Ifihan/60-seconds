...
class _SignupScreenState extends ConsumerState<SignupScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (auth.isAuthenticated) {
      context.go(widget.returnTo ?? '/areas');
    }
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('CREATE ACCOUNT', style: AppTypography.label(color: AppColors.accent)),
              const SizedBox(height: 12),
              Text('Start\nspeaking.', style: AppTypography.display(fontSize: 40)),
              ...
              Center(
                child: GestureDetector(
                  onTap: () => context.pushReplacement('/login${widget.returnTo != null ? "?returnTo=${widget.returnTo}" : ""}'),
